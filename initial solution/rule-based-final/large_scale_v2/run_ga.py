...
# -*- coding: utf-8 -*-
"""
Large Scale GA Optimizer Runner
Just run this file to start GA optimization with large scale parameters (112 min interarrival)
"""
...
if __name__ == "__main__":
    # Default configuration for large scale GA optimization
    # Using absolute paths based on script directory
    default_args = [
        "--work_schedule", os.path.join(script_dir, "lich_lam_viec_tuan1_large.xlsx"),
        "--cap_rank", os.path.join(script_dir, "Cap_Rank.xlsx"),
        "--elective_sched", os.path.join(script_dir, "large_rulebased_output.xlsx"),  # Use rule-based output
    ...
    print("=" * 70)
    print("LARGE SCALE GA OPTIMIZATION")
