# -*- coding: utf-8 -*-
"""
Run Online Simulation for Multiple Seeds (with Multiprocessing) - Medium Scale
...
# Configuration
INITIAL_SCHEDULE = os.path.join(_SCRIPT_DIR, "medium_scale_result.xlsx")
...
def main():
    ...
    print("\n" + "="*80)
    print("RUNNING ONLINE SIMULATION FOR 10 SEEDS (MULTIPROCESSING) - MEDIUM SCALE")
    print("="*80)
