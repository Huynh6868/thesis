...
def solve_heuristic_from_file(dat_file):
    ...
    # --- REPORT ---
    print(f"\nMEDIUM SCALE RESULTS (150 patients):")
...
if __name__ == "__main__":
    ...
    try:
        solve_heuristic_from_file("medium_scale_150p.dat")
    except FileNotFoundError:
        print("ERROR: File 'medium_scale_150p.dat' not found.")
        print("Please run 'data med 150.py' first to generate data!")