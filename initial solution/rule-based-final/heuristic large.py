...
if __name__ == "__main__":
    # Đảm bảo bạn đã chạy file generate_large_scale_dat.py trước để có file .dat
    try:
        solve_heuristic_from_file("large_scale_150p.dat")
    except FileNotFoundError:
        print("Lỗi: Không tìm thấy file 'large_scale_150p.dat'.")
        print("Hãy chạy script 'generate_large_scale_dat.py' trước!")