...
if __name__ == "__main__":
    ...
    if args.mean_interarrival is None:
        args.mean_interarrival = sim.load_urgent_param_from_excel(args.cap_rank, 'Large scale')
        print(f"Loaded mean_interarrival from Excel: {args.mean_interarrival} minutes (Large scale)")
