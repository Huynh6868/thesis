...
if __name__ == "__main__":
    ...
    parser.add_argument("--mean_interarrival", type=float, default=None)
    ...
    # Load urgent parameter from Excel if not provided
    if args.mean_interarrival is None:
        args.mean_interarrival = sim.load_urgent_param_from_excel(args.cap_rank, 'Small scale')
    print(f"Using mean_interarrival: {args.mean_interarrival} (Small scale)")
