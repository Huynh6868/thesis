...
def run_ga_for_scenario(
    ...
    work = sim.WorkSchedule(
        sim.load_work_schedule_xlsx(work_schedule_path),  # Single DataFrame - small scale WorkSchedule signature
...
def main():
    ...
    parser.add_argument("--elective_sched", default=os.path.join(_SCRIPT_DIR, "surgery_schedule.xlsx"))
    ...
    parser.add_argument("--rest_time", type=int, default=sim.DEFAULT_REST_TIME_MIN)
