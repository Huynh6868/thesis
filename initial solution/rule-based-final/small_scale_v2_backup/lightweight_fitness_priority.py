    ...
    while now < max_time:
        ...
        if waiting_urgent:
            ...
            for u in waiting_urgent:
                ...
                for s in [team[0], team[1]] + ([team[2]] if team[2] else []):
                    surg_busy[s] = now + dur + rest_time
        ...
        # ==================================================================
            ...
            for e in eligible:
                ...
                for s in surgeons_needed:
                    surg_busy[s] = now + e.duration + rest_time
                ...
                log.append({
                    ...
                    "start": now,
                    "end": now + e.duration,
                    "end_surgeon": now + e.duration + rest_time,
                    "wait": max(0, delay),
                    "room": e.room,
                    "main": e.main,
                    "assist1": e.assist1,
