...
# ==========================================
# CẤU HÌNH MEDIUM SCALE (80 PATIENTS)
# ==========================================
NUM_PATIENTS = 80
NUM_SURGEONS = 16   # Tăng nhân lực để gánh 80 ca
NUM_DAYS = 5
NUM_ROOMS = 5       # Tăng số phòng để đảm bảo không bị thiếu chỗ
DAY_MINUTES = 480 
...
def generate_dataset_80p(filename="medium_scale_80p.dat"):
    with open(filename, "w", encoding="utf-8") as f:
        f.write("/*********************************************\n")
        f.write(f" * MEDIUM SCALE DATASET (80 Patients)\n")
