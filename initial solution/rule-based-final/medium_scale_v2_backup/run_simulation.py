...
# -*- coding: utf-8 -*-
"""
Medium Scale Simulation Runner
Just run this file to start simulation with medium scale parameters (210 min interarrival)
"""
...
if __name__ == "__main__":
    # Default configuration for medium scale
    default_args = [
